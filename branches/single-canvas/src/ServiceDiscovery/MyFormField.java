...
public class MyFormField{
    ...
    public MyFormField(JabberDataBlock field) {
	    ...
	    hidden= type.equals("hidden"); 
            if (type.equals("fixed")) formItems.addElement(new MultiLine(label, body, StaticData.getInstance().roster.getWidth()));
	    ...
	    // text-single, text-private
            ...
            if ( instructions=name.equals("instructions") )
                formItems.addElement(new MultiLine("Instructions", body, StaticData.getInstance().roster.getWidth()));
            else if ( name.equals("title") )
                formItems.addElement(new MultiLine(null, body, StaticData.getInstance().roster.getWidth()));
